...
class EagleBackbone(nn.Module):
    def __init__(
        ...
        # Override flash_attention_2 -> sdpa (flash_attn package not available)
        ...
        self.eagle_model = AutoModel.from_config(config, trust_remote_code=True, attn_implementation="sdpa")
